<?php
	...
	$title = '[Peeko Contact Form] Message from a site visitor';;
	
	$site_owners_email = 'shahruksemail@gmail.com'; // Replace this with your own email address
	$site_owners_name = 'Peeko'; // replace with your name
